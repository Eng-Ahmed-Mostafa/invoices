...
=======
    ...
    @endif
>>>>>>> Edit
    <form id="invoiceForm" action="{{ route('dashboard.invoices.store') }}" method="POST">
        @csrf
        <div class="row g-3 mb-3">
            <div class="col">
                <label for="invoice_number">Invoice Number</label>
                <input id="invoice_number" name="invoice_number" type="text" class="form-control"
            ...
            <div class="col">
<<<<<<< HEAD
                <label for="time">Invoice Time</label>
                <input class="form-control" type="date" name="invoice_date" id="">
                @error('invoice_date')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
...
<<<<<<< HEAD
        <div class="row g-3 mb-3">
            <div class="col">
                ...
                <input id="totalAmount" type="text" name="total_amount" id="" readonly class="form-control">
                @error('total_amount')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="table-responsive">
            <div id="productsWrapper">
                @include('dashboard.invoices.data')
            </div>
...
=======
            ...
            $(document).on('change keyup', '#productSelect', function() {
                ...
                $('#quantityInput').attr('max',baseQuantity);
                ...
                for (let key in selectedProducts) {
                    ...
                    productTable += `
                        <tr>
                            ...
                            <td>${product.price}</td>
                            <td><input min='1' max='${product.baseQuantity}' class='form-control quantityEditInput' type='number' value='${Number(product.quantity)}' data-id='${key}'></td>
                            <td>
